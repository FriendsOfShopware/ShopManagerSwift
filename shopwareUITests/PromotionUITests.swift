...
final class PromotionUITests: XCTestCase {
    ...
    func testListingFiltersSearchAndAdaptiveLayout() {
        ...
        wait(element("promotions.row.promotion-0", app), "exists == false")
    ...
    func testDiscountAndConditionsEditors() {
        ...
        tap("promotion.editor.save", app); wait(element("promotion.editor.save", app), "exists == false")
    ...
    func testPartialDeleteAndListingRetry() {
        ...
        wait(element("promotions.row.promotion-2", app), "exists == false")
